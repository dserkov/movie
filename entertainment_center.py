...
casino = media.Movie("Casino",
			     ...
			     Scorsese and starring Robert De Niro, Joe Pesci, and Sharon Stone.\
			     It is based on the non-fiction book Casino: Love and Honor in Las\
			     Vegas",
...
goodfellas = media.Movie("Goodfellas",
			     ...
			     directed by Martin Scorsese. It is an adaptation of the 1986\
			     non-fiction book Wiseguy by Nicholas Pileggi",
...
once_upon_a_time_in_merica = media.Movie("Once Upon a Time in America",
			     ...
			     drama film co-written and directed by Italian filmmaker Sergio\
			     Leone and starring Robert De Niro and James Woods",
...
king_of_new_york = media.Movie("King of New York",
			     ...
			     Wesley Snipes, Victor Argo, and Giancarlo Esposito",
...
a_bronx_tale = media.Movie("A Bronx Tale",
			     ...
			     during the turbulent era of the 1960s. It was the directorial\
			     debut of Robert De Niro that follows a young Italian-American\
			     teenager in The Bronx, New York as his path in life is guided by\
			     two father figures, played by De Niro as his biological father\
			     and Chazz Palminteri as a local mafia boss. It was written by\
